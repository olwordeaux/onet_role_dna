...
```sh
uv add onet_role_dna
```

### What's in the scaffold

- `src/onet_role_dna/` package with CLI (Typer + Rich), py.typed marker
...
[@olwordeaux](https://github.com/olwordeaux) (Andy Eick) created onet_role_dna.
