...
If you find a security vulnerability in onet_role_dna, please report it through [GitHub's private vulnerability reporting](https://github.com/olwordeaux/onet_role_dna/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact andy.eick@gmail.com for details.
